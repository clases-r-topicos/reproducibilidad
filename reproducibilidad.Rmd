...
### Público objetivo: Usuarios y usuarias intermedios de R con algunos conocimientos de Git
]
...
- Solo puedo escribir línea por línea
...
.panel[.panel-name[¿Cómo funciona?]

.center[<img src = "imagenes/esquema-rmarkdown.JPG" width=800/>]
...
Es es sucesor del paquete `packrat`
...
.pur[.Rprofile:] es un archivo que ejecuta RStudio cada vez que se carga una sesión. Este archivo llama a 
